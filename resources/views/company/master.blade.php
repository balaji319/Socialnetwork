...
<head>
    ...
    <link href="{{asset('company_theme/assets/css/demo.css')}}" rel="stylesheet" />
...
<div class="wrapper">
    ...
    <!--   Core JS Files   -->
    <script src="{{asset('company_theme/assets/js/jquery-1.10.2.js')}}" type="text/javascript"></script>
	<script src="{{asset('company_theme/assets/js/bootstrap.min.js')}}" type="text/javascript"></script>
	...
	<script src="{{asset('company_theme/assets/js/demo.js')}}"></script>
